...
btn_br1=tk.Button(root,text="(",command=lambda:add_to_calculation("("),width=5,font=("Ariel",14))
btn_br1.grid(row=5,column=1)

btn_br2=tk.Button(root,text=")",command=lambda:add_to_calculation(")"),width=5,font=("Ariel",14))
btn_br2.grid(row=5,column=3)

btn_eq=tk.Button(root,text="=",command=evaluvate_calculation,width=10,font=("Ariel",14))
btn_eq.grid(row=6,column=3,columnspan=2)

btn_cl=tk.Button(root,text="C",command=clear_field,width=10,font=("Ariel",14))
